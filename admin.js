...
function loadSupabaseSettings() {
  ...
  const DEFAULT_URL = "https://hpueskpwzvbiuojerhdx.supabase.co";
  const DEFAULT_KEY = "sb_publishable_Z0JDB9Dt2kIvUCIFOIlNRQ_APTqICD-";
  ...
  if (geminiInput) {
    const storedGemini =
      ...
      "AIzaSyDdjLORlj_a5tF8e1M--wzl7PBg0XPC5yc";
